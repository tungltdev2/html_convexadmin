...
<html lang="en" class="loading">
  <head>
    ...
    <title>Analytics Dashboard - Convex bootstrap 4 admin dashboard template</title>
                          ...
                          <div class="chat">
                            <div class="chat-avatar">
                              <a class="avatar" data-toggle="tooltip" href="#" data-placement="right" title="" data-original-title="">
                                  <img src="app-assets/img/portrait/small/avatar-s-19.jpg" alt="avatar" />
                              </a>
                            </div>
                            <div class="chat-body">
                          ...
                          <div class="chat chat-left">
                            <div class="chat-avatar">
                              <a class="avatar" data-toggle="tooltip" href="#" data-placement="left" title="" data-original-title="">
                                <img src="app-assets/img/portrait/small/avatar-s-15.jpg" alt="avatar" />
                              </a>
                            </div>
                            <div class="chat-body">
                              <div class="chat-content">
                        ...
                        <table id="recent-orders" class="table table-hover table-xl mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-truncate">
                                        <span class="avatar avatar-xs">
                                            <img class="box-shadow-2" src="app-assets/img/portrait/small/avatar-s-15.jpg" alt="avatar">
                                        </span>
                                        <span>Andrew D.</span>
                                    </td>
                                    <td class="text-truncate p-1">
...
<div class="row match-height">
            ...
            <div class="card-body">
                <div class="card-block">
                    <div class="media mb-3">
                        <img alt="96x96" class="media-object d-flex mr-3 align-self-center bg-primary height-50 rounded-circle" src="app-assets/img/portrait/small/avatar-s-12.jpg">
                    ...
                    <div class="media mb-3">
                        <img alt="96x96" class="media-object d-flex mr-3 align-self-center bg-danger height-50 rounded-circle" src="app-assets/img/portrait/small/avatar-s-11.jpg">
                        <div class="media-body">
                    ...
                    <div class="media mb-3">
                        <img alt="96x96" class="media-object d-flex mr-3 align-self-center bg-success height-50 rounded-circle" src="app-assets/img/portrait/small/avatar-s-3.jpg">
                        <div class="media-body">
                    ...
                    <div class="media mb-3">
                        <img alt="96x96" class="media-object d-flex mr-3 align-self-center bg-warning height-50 rounded-circle" src="app-assets/img/portrait/small/avatar-s-6.jpg">
                        <div class="media-body">
    ...
    <!-- END CONVEX JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="app-assets/js/dashboard-analytics.js"></script>
    <!-- END PAGE LEVEL JS-->
  </body>
</html>